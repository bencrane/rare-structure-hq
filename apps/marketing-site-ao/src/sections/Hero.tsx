  ...
  return (
    <section className="grid gap-12 px-6 py-16 sm:px-12 sm:py-20 lg:grid-cols-[1.08fr_0.92fr] lg:gap-16">
      <div className="flex min-w-0 flex-col">
        ...
        <h1 className="mt-8 break-words font-display text-[2.5rem] font-semibold uppercase leading-[0.95] tracking-[-0.02em] text-[color:var(--color-text-primary)] sm:text-[3.75rem] lg:text-[4.75rem]">
        ...
        <p className="mt-8 max-w-[34rem] text-[1.0625rem] leading-[1.6] text-[color:var(--color-text-muted)]">
          ...
          inflection, regulatory transition, or capital constraint. When a market participant
          crosses a compliance threshold or triggers a maturity cliff, Active Operators provides
          immediate, vetted routing to the exact resource required to clear the bottleneck.
        </p>
          ...
          >
            ...
            <div className="flex min-w-0 flex-1 items-center gap-3 px-4 text-[color:var(--color-text-subtle)] focus-within:ring-1 focus-within:ring-[color:var(--color-text-accent)]">
              ...
              <input
                ...
                placeholder="Corporate Entity ID / Email."
