      ...
      aside={
        <div className="border border-[color:var(--color-border-default)] bg-[color:var(--color-surface-raised-translucent)] p-6 sm:p-7">
          <div className="flex items-center justify-between gap-4">
            ...
            <span className="shrink-0 font-mono text-[0.5625rem] uppercase tracking-[0.18em] text-[color:var(--color-state-success)]">
              Live
            </span>
          </div>
          ...
          <div
            className="mt-6 border-t border-[color:var(--color-border-subtle)] pt-6"
            aria-hidden="true"
          >
