...
export const COMMANDS: Command[] = [
  // Canned queries removed 2026-07-15 — the query surface is free-typed only
  // while the phrase grammar is under operator revision (see phrasebook
  // PENDING REVIEW). The typeahead vocabulary will replace this list.
];
