      ...
      <div className="mb-10 border-[color:var(--color-border-subtle)] border-b pb-4">
        ...
        {editable ? (
          <input
            ...
            placeholder="—"
            className="w-28 bg-transparent py-0.5 text-[0.9375rem] text-[color:var(--color-text-muted)] outline-none placeholder:text-[color:var(--color-text-subtle)]"
          />
        ) : (
          <div
    ...
    <div className="flex items-baseline justify-between gap-4 border-[color:var(--color-border-subtle)] border-b py-3">
      ...
      {editable ? (
        <input
          ...
          placeholder="—"
          className="w-28 bg-transparent py-0.5 text-right text-[0.9375rem] text-[color:var(--color-text-muted)] outline-none placeholder:text-[color:var(--color-text-subtle)]"
        />
      ) : (
        <span
