/**
 * Mandate — the operator's portal view of a minted proposal at `/app/m/:ref`.
 *
 * A NATIVE cockpit page: it renders inside the portal shell (the sidebar comes from AppShell, like
 * Dossier/Proposals), loads the proposal by `ref`, and shows the operator's editable mandate UI
 * (`MandateEditor`) keyed to that proposal's template + prospect.
 *
