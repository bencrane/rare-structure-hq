 ...
 *
 * Pure navigation: a 2×2 grid of category cards, one per configuration area. Each
 * routes to its own child surface (`/app/settings/<area>`) that holds that area's
 * controls. This file owns no data and no geometry — just the four entry points.
