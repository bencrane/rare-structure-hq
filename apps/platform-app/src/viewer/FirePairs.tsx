/**
 * FirePairs — pair dispositions for the two waste/environmental buckets.
 *
 ...
 * chips reassign (localStorage `viewer.fire-pairs.v1`); "Copy decisions"
...
const STORAGE_KEY = "viewer.fire-pairs.v1";
...
const SHORT: Record<string, string> = {
  "Wildland Fire & Forestry Services": "Fire",
  Out: "Out",
};

const CAT_COLOR: Record<string, string> = {
  "Wildland Fire & Forestry Services": "#b03030",
  Out: "#888888",
};
  ...
  return (
    <div style={{ padding: "40px 48px", fontSize: 15, lineHeight: 1.5, color: "#1a1a1a" }}>
      <h1 style={{ fontSize: 26, fontWeight: 700, margin: 0 }}>
        Wildland Fire & Forestry Services — pair dispositions
      </h1>
