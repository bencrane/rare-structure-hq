/**
 * MedDevPairs — pair dispositions for the two waste/environmental buckets.
 *
 ...
 * chips reassign (localStorage `viewer.meddev-pairs.v1`); "Copy decisions"
...
const STORAGE_KEY = "viewer.meddev-pairs.v1";
...
const SHORT: Record<string, string> = {
  "Medical Devices & Supplies Manufacturing": "MedDev",
  Out: "Out",
};

const CAT_COLOR: Record<string, string> = {
  "Medical Devices & Supplies Manufacturing": "#1a56a0",
  Out: "#888888",
};
  ...
  return (
    <div style={{ padding: "40px 48px", fontSize: 15, lineHeight: 1.5, color: "#1a1a1a" }}>
      <h1 style={{ fontSize: 26, fontWeight: 700, margin: 0 }}>
        Medical Devices & Supplies Manufacturing — pair dispositions
      </h1>
