/**
 * MedStaffPairs — pair dispositions for the two waste/environmental buckets.
 *
 ...
 * chips reassign (localStorage `viewer.medstaff-pairs.v1`); "Copy decisions"
...
const STORAGE_KEY = "viewer.medstaff-pairs.v1";
  ...
  return (
    <div style={{ padding: "40px 48px", fontSize: 15, lineHeight: 1.5, color: "#1a1a1a" }}>
      <h1 style={{ fontSize: 26, fontWeight: 700, margin: 0 }}>
        Medical & Clinical Staffing — pair dispositions
      </h1>
